<section class="page-section">
  ...
  <?php if(isset($game)): ?>
    <?php
      if($game['type'] == 1) {
        $hiddens = array('id_game' => $game['id_game'], 'question_options' => true, 'images_options' => true);
      } else {
          ...
          <div class="game-content-form clearfix">
            ...
            <div class="form-group">
              ...
              <div class="tabs">
                <div class="tabs-control">
                  <ul>
                    <li class="active">
                      <button type="button" class="btn btn-link" data-tab-target="#alternativas-com-texto">Alternativas com texto</button>
                    </li>
                    <li>
                      <button type="button" class="btn btn-link" data-tab-target="#alternativas-com-images">Alternativas com images</button>
                    </li>
                  </ul>
                </div><!-- .tabs-control -->

                <div class="tabs-content">
                  <div class="tab-item active" id="alternativas-com-texto">
                  ...
                  <div class="tab-item" id="alternativas-com-images">
                    <div class="form-group">
                      <div class="row">
                        <label for="first-option" class="label-control col-md-1">A</label>
                        <?= form_upload(array('name' => 'first-option', 'id' => 'first-option', 'class' => 'input-control', 'required' => 'required')); ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <label for="second-option" class="label-control col-md-1">B</label>
                        <?= form_upload(array('name' => 'second-option', 'id' => 'second-option', 'class' => 'input-control', 'required' => 'required')); ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <label for="third-option" class="label-control col-md-1">C</label>
                        <?= form_upload(array('name' => 'third-option', 'id' => 'third-option', 'class' => 'input-control', 'required' => 'required')); ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <label for="fourth-option" class="label-control col-md-1">D</label>
                        <?= form_upload(array('name' => 'fourth-option', 'id' => 'fourth-option', 'class' => 'input-control', 'required' => 'required')); ?>
                      </div>
                    </div>
            ...
            <div class="form-group clearfix">
              ...
              <div class="col-md-4">
                ...
                echo form_dropdown('correct-answer', $options, set_value('correct-answer'), array('class' => 'input-control col-md-12', 'required' => 'required'));
                ?>
              </div>

              <div class="col-md-4">
                <input type="submit" class="btn btn-blue col-md-8" value="Cadastrar questão" name="btn-add-imagem" id="btn-add-imagem">
              </div>

            </div>

            <input type="hidden" name="question-type" id="question-type" value="1">
            <?= form_close(); ?>
          </div>
