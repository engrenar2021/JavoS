    ...
    <div class="game-config">
      <?php if($game['type'] == 1): ?>
        <div class="game-content">
          ...
          <div class="game-content-form clearfix">
            <?= form_open_multipart(base_url('gerenciador/adicionar-asset/imagem'), array('class' => 'form-default', 'novalidate' => true), $hiddens); ?>
      ...
      <?php if($game['type'] == 2): ?>
        <div class="game-content">
          ...
          <div class="game-content-form clearfix">
            <?= form_open_multipart(base_url('gerenciador/adicionar-asset/audio'), array('class' => 'form-default', 'novalidate' => true), $hiddens); ?>
            <div class="form-group">
              <div class="col-md-5">
                <?= form_upload(array('name' => 'game-asset', 'id' => 'game-asset','required' => 'required')); ?>
              </div>
